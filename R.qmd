...
res_folder_to_process <- "wc2.1_2.5m" # folder with resolution to process
...
for (period in time_periods) {
    for (scenario in ssp) {
      ...
      print(paste("Writing file to disk... Output path: ", output_path))
      write.csv(result, file = paste0(output_path, "/", "cmip6_ext_2_5m_", period,"_", scenario, ".csv"))
...
Para cada combinación de periodos y escenarios socioeconómicos se obtiene un archivo en formato csv con los valores promedios de los modelos climáticos globales (GCMs) para cada una de las 19 bandas que conforman las variables bioclimáticas.
